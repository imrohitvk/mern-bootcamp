...
1. [Bootcamp Overview](#1-bootcamp-overview)
2. [Mode of Bootcamp & Attendance](#2-mode-of-bootcamp--attendance)
...
**1.1 What is this bootcamp about?**  
This MERN Bootcamp is organized by VLED Lab at the Indian Institute of Technology Ropar in online mode. It's a comprehensive full-stack development program focused on the MERN stack (MongoDB, Express.js, React, Node.js/TypeScript).

**1.2 Is this bootcamp time-bound or duration-based?**  
No, this bootcamp is **self-paced**. You can learn at your own speed and complete the modules according to your schedule.

**1.3 What is the mode of this bootcamp?**  
The bootcamp mode will be **online only**.

**1.4 Are there fixed timings or live sessions?**  
The bootcamp is primarily self-paced. However, there may be optional live sessions, office hours, or Q&A sessions scheduled periodically. Check the official communication channels for any scheduled events.

---

## 2. Mode of Bootcamp & Attendance

**2.1 Can we opt for an on-campus/offline bootcamp?**  
The program will be conducted strictly in **online mode**.

**2.2 Is attendance tracked in this bootcamp?**  
Since the bootcamp is **self-paced**, traditional attendance is not tracked. However, if there are optional live sessions or office hours, participation is highly encouraged to get the most out of the program.

**2.3 Do I need to use a specific name or email for the bootcamp?**  
...
After **48 hours**, email the **Bootcamp Sponsor**, CC'ing:
...
**5.1 What are the bootcamp completion criteria?**  
...
Please refer to the official communication from VLED Lab or contact the bootcamp coordinators for information on certification requirements and process.
...
If the issue persists after trying all steps, **record the issue** and email it to: **bootcamp-support@vicharanashala.zohodesk.in** between **9:00 AM and 9:00 PM**.
...
5. Locate **#MERN Bootcamp** and click **Join**.
...
**bootcamp-support@vicharanashala.zohodesk.in** between **9:00 AM and 9:00 PM**.
...
**Note:** Case studies are **supplementary and not required** for bootcamp completion. They are provided for participants who want to deepen their understanding and gain additional practice.
...
2. Fill in all required details carefully, including:
   ...
   - Email ID associated with the bootcamp  
...
Health points are a scoring system used to track individual and class participation and engagement throughout the bootcamp.
